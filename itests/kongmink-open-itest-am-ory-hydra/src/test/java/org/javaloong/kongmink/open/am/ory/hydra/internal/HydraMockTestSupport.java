...
public class HydraMockTestSupport extends PaxExamTestSupport {
    ...
    public Option[] config() {
        ...
        return OptionUtils.combine(super.config(),
                newConfiguration(HydraAdminClient.CONFIGURATION_PID)
                        .put("serverUrl", String.format("http://localhost:%s", serverPort))
                        .asOption()
        );
    }
    ...
    protected Option testBundles() {
        return composite(
                ...
                mavenBundle("org.javaloong.kongmink.open", "kongmink-open-am-ory-hydra").versionAsInProject(),
